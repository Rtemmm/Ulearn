...
public class ParsingTests
{
	...
	{
		var lines = new[] { visitsHeaderLine,  "10;1;2000-12-13;12:99:99" };
		var exception = Assert.Throws<FormatException>(() =>
			ParsingTask.ParseVisitRecords(lines, new Dictionary<int, SlideRecord>()).ToList()
		);

		Assert.That(exception.Message, Is.EqualTo("Wrong line [10;1;2000-12-13;12:99:99]"));
	}
	...
	public void ParseVisits()
	{
		var visits = ParsingTask.ParseVisitRecords(
			...
			new Dictionary<int, SlideRecord>
			{
				...
				{ 14, new SlideRecord(14, SlideType.Theory, "theory slide") }
			});
		Assert.That(visits, Is.EqualTo(new[]
		{
			...
			new VisitRecord(70, 14, new DateTime(2014, 09, 03, 20, 02, 29), SlideType.Theory)
		}));
	}
}